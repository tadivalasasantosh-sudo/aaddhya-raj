        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.linkedin.com/company/aadhyaraj-technologies/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 text-gray-400 hover:text-white hover:bg-white/10 transition-all">
                <Linkedin size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919127912345" className="hover:text-white transition-colors">+91 9127912345</a>
              </li>
              <li className="flex items-center gap-3">
                <MessageCircle size={18} className="text-green-500 shrink-0" />
                <a href="https://wa.me/919127912345" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">WhatsApp Us</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-blue-500 shrink-0" />
                <a href="mailto:tag@aadhyarajtech.com" className="hover:text-white transition-colors">tag@aadhyarajtech.com</a>
              </li>
            </ul>
          </div>
        </div>
