  ...
  return (
    <div className={cn("flex items-center gap-3 group cursor-pointer", className)}>
      ...
      <div className="flex flex-col leading-none justify-center">
        <span className={cn("font-bold tracking-tight text-white", sizes[size].text1)}>Aditya</span>
        <span className={cn("font-medium tracking-widest text-blue-400 uppercase", sizes[size].text2)}>Technology</span>
      </div>
    </div>
  );
};
