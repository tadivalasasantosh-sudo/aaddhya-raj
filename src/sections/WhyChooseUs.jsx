...
export const WhyChooseUs = () => {
  return (
    <section id="why-choose-us" className="py-24 bg-black relative overflow-hidden border-t border-white/5">
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-blue-600/10 rounded-full blur-[120px] -translate-y-1/2" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
              Why Partner With <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Aadhyaraj Technologies?</span>
            </h2>
          ...
          >
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-purple-600/20 rounded-full blur-[40px]" />
