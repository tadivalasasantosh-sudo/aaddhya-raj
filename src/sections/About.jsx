...
export const About = () => {
  ...
  return (
    <section id="about" className="py-32 bg-[#0f172a] relative overflow-hidden border-t border-white/5">
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-emerald-900/20 rounded-full blur-[120px] -z-10 translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          >
            ...
            <div className="flex justify-center gap-12 pt-4">
              ...
              <div className="space-y-2">
                <div className="text-4xl font-bold text-emerald-500">250+</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-white/5 border border-white/10 shadow-sm hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group"
            >
              ...
              <h3 className="text-xl font-bold text-white mb-4 group-hover:text-emerald-400 transition-colors">{value.title}</h3>
